    ...
    <section id="cabinet" className="py-24 bg-white">
      <div className="container px-4">
        ...
        <div className="max-w-6xl mx-auto">
          <div className={`grid md:grid-cols-${Math.min(photos?.length || 2, 2)} gap-8 mb-12`}>
            {photos?.map((photo, i) => {
              ...
              return (
                ...
                >
                  {imageData?.url ? (
                    <img src={imageData.url} alt={photo.caption || ''} className="w-full h-full object-cover" />
                  ) : (
          ...
          <div className={`grid lg:grid-cols-${Math.min(features?.length || 3, 3)} gap-8 text-center`}>
