...
export const Doctor: React.FC = () => {
  return (
    <section id="docteur" className="py-24 bg-nude-400">
      <div className="container px-4">
        {/* Section title */}
        <div className="text-center mb-16">
          <p className="text-white/70 text-sm tracking-[0.3em] uppercase mb-3">Votre spécialiste</p>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          ...
          <div className="relative">
            <div className="aspect-[3/4] rounded-2xl overflow-hidden bg-white/20 shadow-2xl shadow-nude-700/10">
              <div className="w-full h-full flex items-center justify-center">
                <div className="text-center">
                  <svg className="w-24 h-24 text-white/40 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={0.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                  </svg>
                  <p className="text-white/60 text-sm italic">Photo du Docteur</p>
                </div>
              </div>
            </div>
            {/* Decorative frame */}
